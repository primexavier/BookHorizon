      ...
      <div class="container">
        <div class="row space-db-lg--60 space-db--30">
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              <a href="blog-details.html" class="image d-block">
                <img src="{{ asset('frontend/image/others/blog-grid-2.jpg') }}" alt="">
              </a>
              <div class="card-content">
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              <a href="blog-details.html" class="image d-block">
                <img src="{{ asset('frontend/image/others/blog-grid-3.jpg') }}" alt="">
              </a>
              <div class="card-content">
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              <a href="blog-details.html" class="image d-block">
                <img src="{{ asset('frontend/image/others/blog-grid-4.jpg') }}" alt="">
              </a>
              <div class="card-content">
